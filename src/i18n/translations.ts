...
export const translations = {
  pl: {
    ...
    badges: {
      ...
      transport: {
        title: "Porównaj transport",
        subtitle: "Analizujemy realny czas podróży (Door-to-Door), ukryte koszty i wskaźnik stresu.",
        calculating: "Przeliczanie tras i kosztów Door-to-Door...",
  ...
  en: {
    ...
    badges: {
      ...
      transport: {
        ...
        subtitle: "We analyze real Door-to-Door travel time, hidden costs, and stress score.",
        calculating: "Calculating routes and Door-to-Door costs...",
