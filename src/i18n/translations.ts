...
export const translations = {
  pl: {
    ...
    tripCreatorStep2: {
      ...
      distance_label: 'Szacowany dystans',
      option_car: 'Podróż samochodem',
      car_logged_only_title: 'Opcja dla zalogowanych',
      car_logged_only_desc: 'Zaloguj się, aby obliczać koszty paliwa i zapisać parametry auta w profilu.',
      fuel_consumption_label: 'Spalanie (l/100 km)',
      fuel_price_label: 'Cena paliwa (PLN/l)',
      car_total_cost: 'Szacowany koszt paliwa:',
      button_select_option: 'Wybierz tę opcję',
      button_selected: 'Wybrano',
      external_flight_search: 'Szukaj lotów (Google Flights)',
      external_train_search: 'Szukaj połączeń (Google Maps / PKP)',
    },
  ...
  en: {
    ...
    tripCreatorStep2: {
      ...
      option_car: 'Travel by car',
      car_logged_only_title: 'Logged-in users only',
      car_logged_only_desc: 'Log in to calculate fuel costs and save your vehicle profile.',
      fuel_consumption_label: 'Consumption (l/100 km)',
      fuel_price_label: 'Fuel price (PLN/l)',
      car_total_cost: 'Estimated fuel cost:',
      button_select_option: 'Select this option',
      button_selected: 'Selected',
      external_flight_search: 'Search flights (Google Flights)',
      external_train_search: 'Search routes (Google Maps)',
    },
